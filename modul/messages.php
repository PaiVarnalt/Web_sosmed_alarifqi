...
$search_user = trim($_GET['q'] ?? ''); 

// Query untuk mendapatkan daftar user yang pernah berinteraksi (Percakapan Aktif)
...
// Query untuk mendapatkan daftar pengguna yang BISA diajak chat (Saling Follow)
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3 p-0 border-end">
            ...
            if ($q_conversations->rowCount() > 0) {
                while ($conv = $q_conversations->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "  <strong>@" . htmlspecialchars($partner) . "</strong>";
        ...
        <div class="col-md-6 p-5 text-center text-muted border-end">
